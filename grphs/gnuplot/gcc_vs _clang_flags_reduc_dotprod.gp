...
set output 'gcc_clang_allflags_reduc_dotprod.png'
...
plot newhistogram, 'dgemm_60x35_gcc_-O1.dat' using 13:xtic(1) ti "gcc", \
    ...
    newhistogram, 'reduc_60x35_gcc_-O1.dat' using 14:xtic(1) ti "gcc",  \
    'reduc_60x35_clang_-O1.dat' using 14:xtic(1) ti "clang",  \
    newhistogram,'dotprod_60x35_clang_-O1.dat' using 14:xtic(1) ti "gcc",    \
    'dotprod_60x35_clang_-O1.dat' using 14:xtic(1) ti "-clang",    \
