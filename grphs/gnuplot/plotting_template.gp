...
#'dgemm_60x35_clang_-O1.dat' using 13:xtic(1) ti "-O1",'dgemm_60x35_clang_-O2.dat' using 13:xtic(1) ti "-O2",'dgemm_60x35_clang_-O3.dat' using 13:xtic(1) ti "-O3",'dgemm_60x35_gcc_-O1.dat' using 13:xtic(1) ti "-O1",'dgemm_60x35_gcc_-O2.dat' using 13:xtic(1) ti "-O2",'dgemm_60x35_gcc_-O3.dat' using 13:xtic(1) ti "-O3",
