...
set output 'clang_dif_size_flagsO3.png'
...
plot  newhistogram, 'dgemm_60x35_clang_-O3.dat' using 13:xtic(1) ti "60x60",        \
                    'dgemm_100x35_clang.dat' using 13:xtic(1) ti "100x100",    \
      newhistogram, 'reduc_60x35_clang_-O3.dat' using 14:xticlabels("REDUC") ti " 60x60",      \
                    'reduc_100x35_clang.dat' using 14:xticlabels("REDUC") ti "100x100",    \
      newhistogram, 'dotprod_60x35_clang_-O3.dat' using 14:xticlabels("DOTPROD") ti "60x60",     \
