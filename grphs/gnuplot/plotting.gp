...
##  gcc
plot 'dgemm_60x35_gcc_-Ofast.dat' using 13:xtic(1) ti "-Ofast" lc rgb '#B3CDE3','dgemm_60x35_gcc_-O1.dat' using 13:xtic(1) ti "-O1" lc rgb '#807DBA','dgemm_60x35_gcc_-O2.dat' using 13:xtic(1) ti "-O2" lc rgb '#807DBA','dgemm_60x35_gcc_-O3.dat' using 13:xtic(1) ti "-O3" lc rgb '#807DBA',
